                            ...
                            <tr id="<?php echo $item['id'] ?>">
                                ...
                                <td>
                                    ...
                                    <?php
                                        ...
                                        $name = \App\User::orderBy('id','desc')->where('id',$item->user_id)->get()->toArray();
                                        foreach($name as $item_name)
                                            echo  "<a href='../project/"."'>".$item_name['name']." ".$item_name['fname']."</a>";
