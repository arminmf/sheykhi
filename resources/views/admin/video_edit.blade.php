...
<div class="col-md-12">
    <div class="box box-warning">
        ...
        <div class="box-body" style="display: block;">
            {!! Form::model($model,['files' => true,'method'=>'PATCH','route'=>['admin.video.update',$model->id]]) !!}
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                {!! Form::label('link_video2','لینک مستقیم ویدیو کیفیت ۲') !!}
            ...
            <div class="col-md-6">
                {!! Form::label('link_video3',' لینک مستقیم ویدیو کیفیت ۳') !!}
            ...
            <div class="col-md-12">
                <br>
                <div class="col-md-12">
                    {!! Form::submit('ویرایش ویدیو',['style'=>'float:left','class'=>'btn btn-success']) !!}
                </div>
            </div>
            {!! Form::close() !!}
        </div>
