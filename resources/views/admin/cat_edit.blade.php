    ...
    <div class="col-md-12">
        <div class="box box-warning">
            ...
            <div class="box-body" style="display: block;">
                {!! Form::model($model,['method'=>'PATCH','route'=>['admin.cat.update',$model->id]]) !!}
                <div class="col-md-4 ">
                ...
                <div class="col-md-4">
                    ...
                    @endif
                    {!! Form::select('parent',$cat, null, array('class' => 'form-control')) !!}
                </div>
                <div class="col-md-4">
                    ...
                    <select class="form-control" id="parent" name="post_type">
                        <option value="prjct">پروژه</option>
                        <option value="news">اخبار</option>
                        <option value="event">ایونت</option>
